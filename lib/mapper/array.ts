...
export interface FLOOR_SEMITYPED__LENGTH_PREFIX_WITHOUT_LENGTH_ENCODING extends BaseEncodingDefinition {
  readonly type: EncodingType.Array;
  readonly encoding: 'FLOOR_SEMITYPED__LENGTH_PREFIX_WITHOUT_LENGTH';
...
export type ArrayEncoding =
  ...
  FLOOR_SEMITYPED__LENGTH_PREFIX_WITHOUT_LENGTH_ENCODING |
