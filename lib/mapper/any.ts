...
export interface ANY_TYPE_PREFIX_ENCODING extends BaseEncodingDefinition {
  readonly type: EncodingType.Any;
  readonly encoding: 'ANY_TYPE_PREFIX';
  readonly options: NoOptions;
}

export type AnyEncodingNames = 'ANY_TYPE_PREFIX'
export type AnyEncoding = ANY_TYPE_PREFIX_ENCODING
