...
exports.UNBOUNDED_TYPED__LENGTH_PREFIX = exports.FLOOR_TYPED__LENGTH_PREFIX = exports.ROOF_8BITS_TYPED__LENGTH_PREFIX = exports.ROOF_TYPED__LENGTH_PREFIX = exports.BOUNDED_8BITS_TYPED__LENGTH_PREFIX = exports.BOUNDED_TYPED__LENGTH_PREFIX = exports.UNBOUNDED_SEMITYPED__LENGTH_PREFIX = exports.ROOF_8BITS_SEMITYPED__LENGTH_PREFIX = exports.ROOF_SEMITYPED__LENGTH_PREFIX = exports.FLOOR_SEMITYPED__LENGTH_PREFIX = exports.FLOOR_SEMITYPED__LENGTH_PREFIX_WITHOUT_LENGTH = exports.BOUNDED_SEMITYPED__LENGTH_PREFIX = exports.BOUNDED_8BITS_SEMITYPED__LENGTH_PREFIX = void 0;
...
var FLOOR_SEMITYPED__LENGTH_PREFIX_WITHOUT_LENGTH = function (buffer, offset, value, options, context) {
    assert_1.strict(options.minimum >= 0);
    assert_1.strict(options.size >= options.minimum);
    return encodeArray(buffer, offset, value, options.prefixEncodings, context);
};
exports.FLOOR_SEMITYPED__LENGTH_PREFIX_WITHOUT_LENGTH = FLOOR_SEMITYPED__LENGTH_PREFIX_WITHOUT_LENGTH;
var FLOOR_SEMITYPED__LENGTH_PREFIX = function (buffer, offset, value, options, context) {
    ...
    return lengthBytes + exports.FLOOR_SEMITYPED__LENGTH_PREFIX_WITHOUT_LENGTH(buffer, offset + lengthBytes, value, {
        minimum: options.minimum,
        size: value.length,
