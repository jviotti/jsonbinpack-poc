...
tap_1.default.test('BOUNDED should encode 5 (0..10)', function (test) {
    ...
    var offset = 0;
    var bytesWritten = encode_1.BOUNDED(buffer, offset, 5, 0, 10);
...
tap_1.default.test('BOUNDED should encode 5 (5..10)', function (test) {
    var buffer = Buffer.allocUnsafe(1);
    var offset = 0;
    var bytesWritten = encode_1.BOUNDED(buffer, offset, 5, 5, 10);
...
tap_1.default.test('BOUNDED should encode 5 (4..10)', function (test) {
    var buffer = Buffer.allocUnsafe(1);
    var offset = 0;
    var bytesWritten = encode_1.BOUNDED(buffer, offset, 5, 4, 10);
...
tap_1.default.test('BOUNDED should encode 0 (0..0)', function (test) {
    ...
    var offset = 0;
    var bytesWritten = encode_1.BOUNDED(buffer, offset, 0, 0, 0);
    test.strictSame(buffer, Buffer.from([0]));
...
tap_1.default.test('BOUNDED should encode 5 (5..5)', function (test) {
    var buffer = Buffer.alloc(1, 0);
    var offset = 0;
    var bytesWritten = encode_1.BOUNDED(buffer, offset, 5, 5, 5);
    test.strictSame(buffer, Buffer.from([0]));
    test.is(bytesWritten, 0);
    test.end();
});
...
tap_1.default.test('BOUNDED should encode -2 (-5..10)', function (test) {
    var buffer = Buffer.allocUnsafe(1);
    var offset = 0;
    var bytesWritten = encode_1.BOUNDED(buffer, offset, -2, -5, 10);
...
tap_1.default.test('BOUNDED should encode -2 (-5..-1)', function (test) {
    var buffer = Buffer.allocUnsafe(1);
    var offset = 0;
    var bytesWritten = encode_1.BOUNDED(buffer, offset, -2, -5, -1);
    test.strictSame(buffer, Buffer.from([3]));
    test.is(bytesWritten, 1);
    test.end();
});
tap_1.default.test('BOUNDED should encode 5 (0..65535)', function (test) {
    ...
    var offset = 0;
    var bytesWritten = encode_1.BOUNDED(buffer, offset, 5, 0, 65535);
...
tap_1.default.test('BOUNDED_MULTIPLE should encode 5 (0..10) / 5', function (test) {
    var buffer = Buffer.allocUnsafe(1);
    var offset = 0;
    var bytesWritten = encode_1.BOUNDED_MULTIPLE(buffer, offset, 5, 0, 10, 5);
    test.strictSame(buffer, Buffer.from([1]));
    test.is(bytesWritten, 1);
    test.end();
});
tap_1.default.test('BOUNDED_MULTIPLE should encode 0 (0..10) / 5', function (test) {
    var buffer = Buffer.allocUnsafe(1);
    var offset = 0;
    var bytesWritten = encode_1.BOUNDED_MULTIPLE(buffer, offset, 0, 0, 10, 5);
    test.strictSame(buffer, Buffer.from([0]));
    test.is(bytesWritten, 1);
    test.end();
});
tap_1.default.test('BOUNDED_MULTIPLE should encode 10 (0..10) / 5', function (test) {
    var buffer = Buffer.allocUnsafe(1);
    var offset = 0;
    var bytesWritten = encode_1.BOUNDED_MULTIPLE(buffer, offset, 10, 0, 10, 5);
...
tap_1.default.test('BOUNDED_MULTIPLE should encode -5 (-20..10) / 5', function (test) {
    var buffer = Buffer.allocUnsafe(1);
    var offset = 0;
    var bytesWritten = encode_1.BOUNDED_MULTIPLE(buffer, offset, -5, -20, 10, 5);
    test.strictSame(buffer, Buffer.from([3]));
    test.is(bytesWritten, 1);
    test.end();
});
...
tap_1.default.test('ROOF should encode 10 (..10)', function (test) {
    ...
    var offset = 0;
    var bytesWritten = encode_1.ROOF(buffer, offset, 10, 10);
...
tap_1.default.test('ROOF_MULTIPLE should encode 10 (..10) / 10', function (test) {
    var buffer = Buffer.allocUnsafe(4);
    var offset = 0;
    var bytesWritten = encode_1.ROOF_MULTIPLE(buffer, offset, 10, 10, 10);
    test.strictSame(buffer, Buffer.from([
        206,
        204,
        204,
...
tap_1.default.test('FLOOR should encode 3 (0..)', function (test) {
    var buffer = Buffer.allocUnsafe(4);
    var offset = 0;
    var bytesWritten = encode_1.FLOOR(buffer, offset, 3, 0);
    test.strictSame(buffer, Buffer.from([
        3,
        0,
        0,
...
tap_1.default.test('FLOOR_MULTIPLE should encode 10 (0..) / 5', function (test) {
    var buffer = Buffer.allocUnsafe(4);
    var offset = 0;
    var bytesWritten = encode_1.FLOOR_MULTIPLE(buffer, offset, 10, 0, 5);
    test.strictSame(buffer, Buffer.from([
        2,
        0,
        0,
